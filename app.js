...
const i18n = {
  ar: {
    ...
    "snapshot.item2": "أتعامل مع الكود بجدية: أفهمه، أرتبه، وأحاول أن أجعله أسهل للتطوير والصيانة.",
    "snapshot.item3": "أعرض مشاريعي بروابط وصور وتفاصيل تقنية حتى يكون الحكم على عملي عمليًا وليس مجرد كلام.",
    "snapshot.item4": "أبحث عن فرصة أتعلم فيها بسرعة، وأثبت نفسي من خلال الالتزام والنتيجة.",
    ...
    "certificates.note": "أضيف هنا الشهادات التي تثبت عملي على الخوارزميات، حل المشكلات، C، ومفاهيم OOP.",
    "certificates.open": "فتح الشهادة",
    "certificates.card1.title": "Algorithms & Problem Solving - Level 3",
    "certificates.card1.text": "تدريب متقدم على التفكير الخوارزمي وتحليل المشكلات.",
  ...
  en: {
    ...
    "snapshot.item2": "I take code seriously: I read it, organize it, and try to make it easier to develop and maintain.",
    "snapshot.item3": "I show my projects with links, images, and technical details so my work can be judged practically.",
    "snapshot.item4": "I am looking for an opportunity to learn fast and prove myself through commitment and results.",
    ...
    "certificates.note": "Here I include certificates that support my work in algorithms, problem solving, C, and OOP concepts.",
    "certificates.open": "Open Certificate",
    "certificates.card1.title": "Algorithms & Problem Solving - Level 3",
    "certificates.card1.text": "Advanced training in algorithmic thinking and problem analysis.",
    "certificates.card2.title": "Introduction to Programming using C - Level 2",
...
const defaults = {
  identity: {
    ...
    role: { ar: "Junior Full Stack Developer | C# .NET | Web | Flutter", en: "Junior Full Stack Developer | C# .NET | Web | Flutter" },
    availability: {
      ar: "أبحث عن فرصة Junior أقدم فيها قيمة عملية من أول مشروع",
      en: "Looking for a junior opportunity where I can deliver practical value from the first project",
    },
    headline: {
      ar: "أنا محمد القحوم، مطور Junior أبني مشاريعي بعقلية تعلم وتنظيم ونتيجة.",
      en: "I am Mohammed Alqahom, a junior developer building projects with a mindset of learning, organization, and results.",
    },
    bio: {
      ar: "أنا مطور Junior أركز على بناء أنظمة عملية تجمع بين الواجهات، الباك إند، وقواعد البيانات. عملت على مشاريع باستخدام Flutter وDart وPHP وMySQL وC# وSQL Server وتقنيات الويب وC++. أعتمد على OOP والبرمجة المهيكلة، وأهتم بأن يكون الكود منظمًا والنتيجة قابلة للعرض والفحص.",
      en: "I am a junior developer focused on building practical systems that connect interfaces, backend logic, and databases. I have worked on projects using Flutter, Dart, PHP, MySQL, C#, SQL Server, web technologies, and C++. I rely on OOP and structured programming, and I care about organized code and work that can be shown and reviewed.",
    },
    photo: "assets/profile-mohammed.png",
  },
  metrics: { projects: 12, technologies: 12, certificates: 4 },
  links: {
