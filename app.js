...
const defaults = {
  identity: {
    ...
    bio: {
      ar: "أنا مطور Junior أركز على بناء أنظمة عملية تجمع بين الواجهات، الباك إند، وقواعد البيانات. عملت على مشاريع باستخدام Flutter وDart وPHP وMySQL وC# وSQL Server وتقنيات الويب وC++. أعتمد على OOP والبرمجة المهيكلة، وأقوي نفسي في الخوارزميات وحل المشكلات المتقدمة حتى أتعامل مع التعقيد بثقة وكود منظم قابل للفحص.",
      en: "I am a junior developer focused on building practical systems that connect interfaces, backend logic, and databases. I have worked on projects using Flutter, Dart, PHP, MySQL, C#, SQL Server, web technologies, and C++. I rely on OOP and structured programming, and I strengthen myself in algorithms and advanced problem solving so I can handle complexity with confidence and reviewable organized code.",
    },
